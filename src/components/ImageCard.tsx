  ...
  return (
    <motion.div {...props}>
      <motion.div
        ...
        className={
          "aspect-w-3 aspect-h-2 relative isolate m-4 flex h-[320px] max-h-[320px] w-[480px] max-w-[480px] overflow-hidden rounded-xl border-none border-gray-800 bg-gray-400 bg-opacity-10 p-4 text-white shadow-2xl"
        }
      >
